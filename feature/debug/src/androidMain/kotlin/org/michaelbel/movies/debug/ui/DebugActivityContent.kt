    ...
    MoviesTheme(
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    SettingItem(
                        title = stringResource(R.string.debug_notification_dialog_expire_reset),
                        description = stringResource(R.string.debug_notification_dialog_expire_reset_description),
                        icon = painterResource(MoviesAndroidIcons.MovieFilter24),
                        onClick = viewModel::resetNotificationExpireTime
                    )
                }
