...
@Composable
fun ScreenState.primaryContainer(isAmoledTheme: Boolean): Color {
    return when (this) {
...
@Composable
fun ScreenState.onPrimaryContainer(isAmoledTheme: Boolean): Color {
    return when (this) {
...
@Composable
fun ScreenState.scrolledContainerColor(isAmoledTheme: Boolean): Color {
    return when (this) {
